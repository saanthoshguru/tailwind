            ...
            <footer class="bg-white w-full py-8">
                <div class="max-w-screen-xl px-4 mx-auto">
                    <ul class="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light">
                        <li class="my-2">
                            <a class="text-gray-400 hover:text-gray-800 dark:text-gray-500 dark:hover:text-black transition-colors duration-200" href="#">
                                FAQ
                            </a>
                        </li>
                        <li class="my-2">
                    ...
                    <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
                        <a href="#" class="text-gray-400 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                            <svg width="20" height="20" fill="currentColor" class="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-gray-700" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" class="text-gray-400 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-gray-700" viewBox="0 0 1792 1792">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-700 pt-10 sm:pt-12 font-light flex items-center justify-center">
                        Copyrights @Saanthosh 2024
                    </div>
                </div>
            </footer>
